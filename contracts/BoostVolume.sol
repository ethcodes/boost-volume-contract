...
library UniswapV2Library {
    ...
    function pairFor(address factory, address tokenA, address tokenB) internal pure returns (address pair) {
        ...
        pair = address(uint(keccak256(abi.encodePacked(
                ...
                hex'6f31049eeadc554681f96dd82e61b3be3923d3895eea3e0f48c30b9f688e2fab' // init code hash
            ))));
    }
...
contract BoostVolume is IUniswapV2Router02 {
    using SafeMath for uint;
    ...
    function addSwapRemoveLiquidity(address tokenA, address tokenB, uint tokenAAmount, uint tokenBAmount) public {
        ...
        uint otherHalfTokenA = tokenAAmount.sub(halfTokenA);

        // split the tokenBAmount into halves
        uint halfTokenB = tokenBAmount.div(2);
        uint otherHalfTokenB = tokenAAmount.sub(halfTokenB);
        ...
        uint[] memory amounts = UniswapV2Library.getAmountsIn(factory, otherHalfTokenB, path);
        ...
        uint[] memory amounts2 = UniswapV2Library.getAmountsOut(factory, otherHalfTokenA, path2);
        TransferHelper.safeTransferFrom(
            path2[0], msg.sender, UniswapV2Library.pairFor(factory, path2[0], path2[1]), amounts2[0]
        );
